...
A <code>() => { /* ... */ }</code> kódrészlet egy [lambda függvény]({{< ref "posts/2018-10-16-lambda-fuggveny" >}}), így tudunk hagyományos értékek/objektumok helyett kódrészletet átadni a Throws függvénynek.
